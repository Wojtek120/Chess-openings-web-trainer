...
<section class="hero has-background-success" id="trainingFinished">
    <div class="hero-body">

        <div class="container">
            <h1 class="title has-text-white">
                <spring:message
                        code="main-chessboard.training-finished"/>
            </h1>
            <h2 class="subtitle has-text-white">
                <spring:message code="main-chessboard.congratulations"/>
            </h2>
        </div>
    </div>
    </div>
...
<section class="has-background-light">
    ...
    <div class="columns is-mobile  is-centered">
        <div class="column is-4  is-centered">
            <div class="columns is-mobile">
                ...
                <div class="column is-centered">
                    ...
                    <a class="button is-primary is-small" id="saveTreeToDatabase"><spring:message
                            code="main-chessboard.save-to-database"/></a>
        ...
        <div class="column is-4" style="text-align:left;">
            ...
            <h4 id="status"></h4>
            <a class="button is-primary is-small" id="changeOrientationBtn"><spring:message
